...
public class TBinaryProtocol extends TProtocol {
  ...
  public void writeMessageBegin(TMessage message) throws CodecException {
    if (strictWrite_) {
  ...
  public void writeFieldBegin(TField field) throws CodecException {
  ...
  public void writeFieldStop() throws CodecException {
    writeByte(TType.STOP);
  }

  public void writeMapBegin(TMap map) throws CodecException {
  ...
  public void writeListBegin(TList list) throws CodecException {
  ...
  public void writeSetBegin(TSet set) throws CodecException {
  ...
  public void writeBool(boolean b) throws CodecException {
    writeByte(b ? (byte)1 : (byte)0);
  }

  public void writeByte(byte b) throws CodecException {
    inoutTemp[0] = b;
    trans_.write(inoutTemp, 0, 1);
  }

  public void writeI16(short i16) throws CodecException {
    inoutTemp[0] = (byte)(0xff & (i16 >> 8));
    inoutTemp[1] = (byte)(0xff & (i16));
    trans_.write(inoutTemp, 0, 2);
  }

  public void writeI32(int i32) throws CodecException {
  ...
  public void writeI64(long i64) throws CodecException {
  ...
  public void writeDouble(double dub) throws CodecException {
    writeI64(Double.doubleToLongBits(dub));
  }

  public void writeString(String str) throws CodecException {
    try {
      byte[] dat = str.getBytes("UTF-8");
      writeI32(dat.length);
      trans_.write(dat, 0, dat.length);
    } catch (UnsupportedEncodingException uex) {
      throw new CodecException("JVM DOES NOT SUPPORT UTF-8");
    }
  }

  public void writeBinary(ByteBuffer bin) throws CodecException {
  ...
  public TMessage readMessageBegin() throws CodecException {
    int size = readI32();
    if (size < 0) {
  ...
  public TField readFieldBegin() throws CodecException {
    byte type = readByte();
  ...
  public TMap readMapBegin() throws CodecException {
  ...
  public TList readListBegin() throws CodecException {
  ...
  public TSet readSetBegin() throws CodecException {
  ...
  public boolean readBool() throws CodecException {
    return (readByte() == 1);
  }
  ...
  public short readI16() throws CodecException {
    byte[] buf = inoutTemp;
    int off = 0;
  ...
  public int readI32() throws CodecException {
    byte[] buf = inoutTemp;
    int off = 0;
  ...
  public long readI64() throws CodecException {
    byte[] buf = inoutTemp;
    int off = 0;
  ...
  public String readString() throws CodecException {
    int size = readI32();
  ...
  public String readStringBody(int size) throws CodecException {
    try {
  ...
  public ByteBuffer readBinary() throws CodecException {
    int size = readI32();
  ...
  private int readAll(byte[] buf, int off, int len) throws CodecException {
